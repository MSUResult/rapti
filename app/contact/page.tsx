  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-20">
        <div className="w-full h-96 bg-gray-200 rounded-3xl overflow-hidden shadow-inner flex items-center justify-center">
          <p className="text-gray-500 font-medium flex items-center gap-2">
            <Clock className="animate-spin-slow" /> [Map integration: Opposite
            Baliya Kheri Block, Saharanpur]
          </p>
        </div>
      </div>
    </div>
